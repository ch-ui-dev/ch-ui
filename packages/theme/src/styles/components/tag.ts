...
const paletteColorMap: Record<
  Exclude<TagStyleProps["palette"], undefined>,
  string
> = {
  neutral:
    "bg-neutral-200 text-neutral-800 dark:bg-neutral-700 dark:text-neutral-150",
  red: "bg-red-200 text-red-800 dark:bg-red-700 dark:text-red-150",
  orange:
    "bg-orange-200 text-orange-800 dark:bg-orange-700 dark:text-orange-150",
  amber: "bg-amber-200 text-amber-800 dark:bg-amber-700 dark:text-amber-150",
  yellow:
    "bg-yellow-200 text-yellow-800 dark:bg-yellow-700 dark:text-yellow-150",
  ...
  emerald:
    "bg-emerald-200 text-emerald-800 dark:bg-emerald-700 dark:text-emerald-150",
  ...
  indigo:
    "bg-indigo-200 text-indigo-800 dark:bg-indigo-700 dark:text-indigo-150",
  violet:
    "bg-violet-200 text-violet-800 dark:bg-violet-700 dark:text-violet-150",
  purple:
    "bg-purple-200 text-purple-800 dark:bg-purple-700 dark:text-purple-150",
  fuchsia:
    "bg-fuchsia-200 text-fuchsia-800 dark:bg-fuchsia-700 dark:text-fuchsia-150",
  ...
  success:
    "bg-success-200 text-success-800 dark:bg-success-700 dark:text-success-150",
  warning:
    "bg-warning-200 text-warning-800 dark:bg-warning-700 dark:text-warning-150",
...
export const tagRoot: ComponentFunction<TagStyleProps> = (
  ...
  mx(
    "text-xs font-semibold pli-2 plb-0.5 rounded cursor-default",
