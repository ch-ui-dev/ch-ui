...
export const comboboxRoot: ComponentFunction<comboboxStyleProps> = (
  _props,
  ...etc
) => {
...
export const comboboxInput: ComponentFunction<comboboxStyleProps> = (
  _props,
  ...etc
) => {
  return mx("px-2", ...etc);
...
export const comboboxButton: ComponentFunction<comboboxStyleProps> = (
  _props,
  ...etc
) => {
  return mx("", ...etc);
...
export const comboboxContent: ComponentFunction<comboboxStyleProps> = (
  { elevation },
  ...etc
) => {
  return mx(
...
export const comboboxItem: ComponentFunction<comboboxStyleProps> = (
  _props,
  ...etc
) => {
  return mx(
