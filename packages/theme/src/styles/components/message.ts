...
export const messageRoot: ComponentFunction<MessageStyleProps> = (
  { valence, elevation },
  ...etc
) =>
  mx(
    ...
    messageValence(valence),
    ...etc,
  );

export const messageTitle: ComponentFunction<MessageStyleProps> = (
  _props,
  ...etc
) => mx("text-base font-medium mb-2", ...etc);

export const messageBody: ComponentFunction<MessageStyleProps> = (
  _props,
  ...etc
) => mx(...etc);
