...
export const defaultOsButtonColors =
  "bg-white/50 text-neutral-900 dark:bg-neutral-750/50 dark:text-neutral-50";
...
export const buttonRoot: ComponentFunction<ButtonStyleProps> = (
  props,
  ...etc
) => {
...
export const buttonGroup: ComponentFunction<{ elevation?: Elevation }> = (
  props,
  ...etc
) => {
  return mx(
