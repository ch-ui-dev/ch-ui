...
import { MessageValence } from "@ch-ui/types";

export const successText =
  "text-xs font-medium text-success-550 dark:text-success-300";
export const infoText = "text-xs font-medium text-info-550 dark:text-info-300";
export const warningText =
  "text-xs font-medium text-warning-550 dark:text-warning-300";
export const errorText =
  "text-xs font-medium text-error-550 dark:text-error-300";
