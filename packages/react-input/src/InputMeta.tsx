...
const Label = forwardRef<HTMLLabelElement, LabelProps>(
  (
    { __inputScope, asChild, children, ...props }: InputScopedProps<LabelProps>,
    forwardedRef,
  ) => {
...
type DescriptionProps = Omit<
  ComponentPropsWithRef<typeof Primitive.span>,
  "id"
> & { asChild?: boolean };
  ...
  (
    {
      ...
      children,
      ...props
    }: InputScopedProps<DescriptionProps>,
    forwardedRef,
  ) => {
    const { descriptionId, validationValence } = useInputContext(
      INPUT_NAME,
      __inputScope,
    );
  ...
  (
    {
      ...
      children,
      ...props
    }: InputScopedProps<ErrorMessageProps>,
    forwardedRef,
  ) => {
...
type DescriptionAndValidationProps = ComponentPropsWithRef<
  typeof Primitive.p
> & { asChild?: boolean };

const DescriptionAndValidation = forwardRef<
  ...
  (
    {
      ...
      children,
      ...props
    }: InputScopedProps<DescriptionAndValidationProps>,
    forwardedRef,
  ) => {
    const { descriptionId, validationValence } = useInputContext(
      INPUT_NAME,
